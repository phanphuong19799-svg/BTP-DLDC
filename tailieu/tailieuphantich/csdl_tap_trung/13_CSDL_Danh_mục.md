...
## 4.2.4.2. PM02.QLTT.NN.DANHMUC – Danh mục

### 4.2.4.2.1 Dashboard Danh mục

Màn hình

![](../images/mauthuthapCSDL_ngoainganh_danhmuc_dashboard.png)

*Hình 121 – Màn hình Dashboard Danh mục*

#### 4.2.4.2.1.1 Mô tả thông tin trên màn hình
| **STT** | **Tên trường thông tin** | **Kiểu dữ liệu** | **Bắt buộc** | **Mặc định** | **Mô tả** |
| --- | --- | --- | --- | --- | --- |
| 1 | Thống kê số liệu | Card | | | Các con số thống kê hồ sơ Danh mục. |
...
### 4.2.4.2.2 Màn danh sách dữ liệu Danh mục

Màn hình

![](../images/mauthuthapCSDL_ngoainganh_danhmuc_img_001.png)

*Hình 122 – Màn danh sách dữ liệu Danh mục*
...
#### 4.2.4.2.2.2 Chức năng trên màn hình
| **STT** | **Tên chức năng** | **Định dạng** | **Mô tả** |
| --- | --- | --- | --- |
...
### 4.2.4.2.3 Màn hình thông tin chi tiết Danh mục

Màn hình

![](../images/mauthuthapCSDL_ngoainganh_danhmuc_img_002.png)

*Hình 123 – Màn hình thông tin chi tiết Danh mục*
...
### 4.2.4.2.4 Tab Lịch sử chỉnh sửa kết nối Danh mục

Màn hình

![](../images/mauthuthapCSDL_ngoainganh_danhmuc_img_003.png)

*Hình 124 – Tab Lịch sử chỉnh sửa kết nối Danh mục*

#### 4.2.4.2.4.1 Mô tả thông tin trên màn hình
| **STT** | **Tên trường thông tin** | **Kiểu dữ liệu** | **Bắt buộc** | **Mặc định** | **Mô tả** |
| --- | --- | --- | --- | --- | --- |
| 1 | Bảng lịch sử | Table | Có | | Ghi lại các lần thay đổi thông tin kết nối. |

#### 4.2.4.2.4.2 Chức năng trên màn hình
| **STT** | **Tên chức năng** | **Định dạng** | **Mô tả** |
| --- | --- | --- | --- |
| 1 | Xem log | Link | Nhấn để xem chi tiết nội dung thay đổi. |
---

### 4.2.4.2.5 Tab Lịch sử đồng bộ Danh mục

Màn hình

![](../images/mauthuthapCSDL_ngoainganh_danhmuc_img_004.png)

*Hình 125 – Tab Lịch sử đồng bộ Danh mục*
