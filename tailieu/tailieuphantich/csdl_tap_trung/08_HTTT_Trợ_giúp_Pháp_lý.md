...
## 4.2.3.8. HTTT Trợ giúp Pháp lý

### 4.2.3.8.2 PM02.QLTT.TN.TGPL – HTTT Trợ giúp pháp lý

#### 4.2.3.8.2.1 Dashboard HTTT Trợ giúp pháp lý

Màn hình

![](../images/mauthuthapCSDL_tgpl_dashboard.png)

*Hình 112 – Màn hình Dashboard HTTT Trợ giúp pháp lý*

##### 4.2.3.8.2.1.1 Mô tả thông tin trên màn hình
...
##### 4.2.3.8.2.1.2 Chức năng trên màn hình
| **STT** | **Tên chức năng** | **Định dạng** | **Mô tả** |
| --- | --- | --- | --- |
| 1 | Kết xuất | Button | Xuất dữ liệu dashboard ra file báo cáo. |
---

#### 4.2.3.8.2.2 Màn danh sách dữ liệu HTTT Trợ giúp pháp lý

Màn hình

![](../images/mauthuthapCSDL_tgpl_img_001.png)

*Hình 113 – Màn danh sách dữ liệu HTTT Trợ giúp pháp lý*

##### 4.2.3.8.2.2.1 Mô tả thông tin trên màn hình
| **STT** | **Tên trường thông tin** | **Kiểu dữ liệu** | **Bắt buộc** | **Mặc định** | **Mô tả** |
| --- | --- | --- | --- | --- | --- |
...
##### 4.2.3.8.2.2.2 Chức năng trên màn hình
| **STT** | **Tên chức năng** | **Định dạng** | **Mô tả** |
| --- | --- | --- | --- |
...
#### 4.2.3.8.2.3 Màn hình thông tin chi tiết HTTT Trợ giúp pháp lý

Màn hình

![](../images/mauthuthapCSDL_tgpl_img_002.png)

*Hình 114 – Màn hình thông tin chi tiết HTTT Trợ giúp pháp lý*

##### 4.2.3.8.2.3.1 Mô tả thông tin trên màn hình
| **STT** | **Tên trường thông tin** | **Kiểu dữ liệu** | **Bắt buộc** | **Mặc định** | **Mô tả** |
| --- | --- | --- | --- | --- | --- |
| 1 | Thông tin hồ sơ | Section | Có | | Các trường thông tin chi tiết của bản ghi. |

##### 4.2.3.8.2.3.2 Chức năng trên màn hình
| **STT** | **Tên chức năng** | **Định dạng** | **Mô tả** |
| --- | --- | --- | --- |
| 1 | Đóng | Button | Đóng popup chi tiết, quay lại danh sách. |
---

#### 4.2.3.8.2.4 Tab Lịch sử chỉnh sửa kết nối HTTT Trợ giúp pháp lý

Màn hình

![](../images/mauthuthapCSDL_tgpl_img_003.png)

*Hình 115 – Tab Lịch sử chỉnh sửa kết nối HTTT Trợ giúp pháp lý*

##### 4.2.3.8.2.4.1 Mô tả thông tin trên màn hình
| **STT** | **Tên trường thông tin** | **Kiểu dữ liệu** | **Bắt buộc** | **Mặc định** | **Mô tả** |
| --- | --- | --- | --- | --- | --- |
| 1 | Bảng lịch sử | Table | Có | | Ghi lại các lần thay đổi thông tin kết nối. |

##### 4.2.3.8.2.4.2 Chức năng trên màn hình
| **STT** | **Tên chức năng** | **Định dạng** | **Mô tả** |
| --- | --- | --- | --- |
| 1 | Xem log | Link | Nhấn để xem chi tiết nội dung thay đổi. |
---

#### 4.2.3.8.2.5 Tab Lịch sử đồng bộ HTTT Trợ giúp pháp lý

Màn hình

![](../images/mauthuthapCSDL_tgpl_img_004.png)

*Hình 116 – Tab Lịch sử đồng bộ HTTT Trợ giúp pháp lý*

##### 4.2.3.8.2.5.1 Mô tả thông tin trên màn hình
| **STT** | **Tên trường thông tin** | **Kiểu dữ liệu** | **Bắt buộc** | **Mặc định** | **Mô tả** |
| --- | --- | --- | --- | --- | --- |
| 1 | Bảng lịch sử | Table | Có | | Ghi lại các lần thay đổi trạng thái đồng bộ. |

##### 4.2.3.8.2.5.2 Chức năng trên màn hình
| **STT** | **Tên chức năng** | **Định dạng** | **Mô tả** |
| --- | --- | --- | --- |
| 1 | Xem log | Link | Nhấn để xem chi tiết nội dung thay đổi. |
