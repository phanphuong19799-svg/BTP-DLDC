...
export function DatabaseTemplate({ 
  ...
  const generateData = () => {
    const data = [
      ...
      { id: '11', title: 'Hồ sơ đăng ký giám sắc việc giám hộ', icon: FileCheck, color: 'purple', lastMonth: 1456789, thisMonth: 1968089, collected: 5432, processed: 5187, shared: 4876 },
  ...
  const tableData: DatabaseRecord[] = [
    ...
    { name: 'Hồ sơ cấp Giấy ĐKKN kết hôn trong hồn nhân', category: categoryName, todayCount: 20000, errorCount: 30 },
    { name: 'Hồ sơ đăng ký ly khai tử', category: categoryName, todayCount: 20000, errorCount: 30 },
    { name: 'Hồ sơ đăng ký nhận cha, mẹ, con', category: categoryName, todayCount: 20000, errorCount: 30 },
  ];
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {context === 'chia sẻ' ? (
                    ...
                    // Hiển thị số liệu và tăng giảm cho các context khác
