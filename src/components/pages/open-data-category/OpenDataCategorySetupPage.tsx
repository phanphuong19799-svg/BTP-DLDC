            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                <button
                  ...
                  className={`bg-slate-50 border border-slate-200 rounded-lg p-4 text-left transition-all hover:shadow-md hover:border-emerald-300 ${
                    filterStatus === 'all' && filterType === 'all' ? 'ring-2 ring-emerald-500 bg-emerald-50' : ''
                  }`}
                >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                <button
                  ...
                  className={`bg-slate-50 border border-slate-200 rounded-lg p-4 text-left transition-all hover:shadow-md hover:border-emerald-300 ${
                    publishFilterStatus === 'all' ? 'ring-2 ring-emerald-500 bg-emerald-50' : ''
                  }`}
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center">
          ...
          {activeTab === 'statistics' && (
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  {[
                    { name: 'Danh mục A', count: 847, percentage: 92 },
